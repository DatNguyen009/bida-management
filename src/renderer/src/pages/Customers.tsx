  ...
  return (
    <div className="flex gap-6">
      <div className="flex-1">
        ...
        <Input
          className="mb-4 backdrop-blur-xl bg-white/[0.07] border-white/10 text-white"
          ...
          {filtered.map((customer) => (
            <button
              ...
              className={selected?.id === customer.id
                ? 'w-full text-left p-4 rounded-xl border bg-white/10 border-[#d4af37] transition-all'
                : 'w-full text-left p-4 rounded-xl border backdrop-blur-xl bg-white/[0.07] border-white/10 hover:bg-white/10 transition-all'}
